        ...
        <div>
            <section className="header-banner h-96 w-full bg-yellow-50">
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <div className="rounded box-border mt-8 bg-white overflow-hidden focus:outline-none flex items-center p-1">
                        <input type="text" className=" rounded-full px-4 focus:outline-none bg-transparent" placeholder="Search doctor here ......." />
                        <button className="text-sm bg-primary py-3 px-6  text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-5">Search</button>
