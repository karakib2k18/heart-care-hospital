            ...
            <div className="container mx-auto mt-10  bg-white border border-gray-100 hover:shadow-xl  p-4 rounded-lg relative">
                ...
                <div className="flex flex-col items-center my-3 space-y-2">
                    <div className="flex flex-col space-y-3">
                        ...
                        <Link to='/services'><button className="inline-block px-1 py-2 font-semibold text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-8" type="submit">
